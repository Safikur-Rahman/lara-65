   ...
   <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                   @if($item['photo'] !==null)
                    <img src="{{ asset('storage/'.$item['photo']) }}" alt="User Photo" class="rounded-circle me-2" width="50">
                   @else
                     <img src="https://placehold.co/50" class="rounded-circle me-2" alt="User Photo">
                    @endif
